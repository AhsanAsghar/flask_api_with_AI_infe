...
from utils.post_processing_upper import (
...
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 17 # 16 teeth plus one super class
cfg.SOLVER.IMS_PER_BATCH=2
cfg.INPUT.MASK_FORMAT='bitmask'
cfg.MODEL.DEVICE = "cpu"
cfg.TEST.EVAL_PERIOD = 200 # Increase this number if you want to monitor validation performance during training
cfg.MODEL.WEIGHTS = 'models/model_upper_final.pth' # path to the model we just trained
...
upper_teeth_bp = Blueprint('upper_teeth', __name__)
...
@upper_teeth_bp.route('/detect/upper-teeth', methods=['POST'])
def detect_upper_teeth():
    ...
    # Return predictions and image as base64
    return jsonify({
